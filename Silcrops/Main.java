...
public class Main{
	...
	public static void main(String[] args) 
	{
		...
		String infoText = ("\n\nYour selected crop will be in " + RED + "red" + RESET + " or highlighted " + B_BACK + "blue" + RESET + 
		...
		slowPrint(infoText);
		/* Outdated code from when saving a game was possible. Function dropped for ease of publication
	...
	{
		/* Again; Code now defunct as saving game system is no longer used 
